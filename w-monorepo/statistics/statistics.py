...
def write_to_file(filename, ip_address, data):
...
def track_page_visit():
    ...
    if not project_name:
        return 'Project name not specified', 400

    filename = f'page_visits_{project_name}.txt'

    write_to_file(filename, ip_address, '新的访客')
...
def submit_string():
    ...
    write_to_file(filename, ip_address, user_string)
