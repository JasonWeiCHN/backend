...
async def download_file_url(url: str, out: str, info: str):
...
async def download_images(game_info, output_folder):
    pic_url = game_info['header_image']
...
async def process_game(appid):
    ...
    await download_images(game_info, output_folder)
...
async def main():
    appid = 211820  # 替换为你想要获取的appid
    await process_game(appid)
