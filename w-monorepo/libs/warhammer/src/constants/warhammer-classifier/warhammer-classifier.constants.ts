    ...
    files: [
      {
        ...
        nameCN: '独眼战兽群',
        description:
          '<p>开局攻下劳伦洛伦，竖立万魔岩创造“血域”。</p><p>这里是帝国的腹地，周围任何人都可以是我们的敌人，最有实力者，是“皇帝·卡尔·弗兰茨”。</p><p>向南方进攻，摧毁米登领，就能打通前往“阿尔道夫”的道路。</p><p>隐蔽营地可以隐藏部队，卡扎克·独眼拥有很高的伏击率，进入战场后，大量先锋部署的部队，可以让我们占得先机。</p><p>利用好角兽群先锋部署和潜行，即可轻易撕碎帝国的部队。</p><p>攻下“阿尔道夫”，灭掉“皇帝·卡尔·弗兰茨”，即可完成破局。</p>',
        id: 'Warherd_of_the_One_Eye',
        contributors: [
          {
            id: 3,
            name: '温酱与夏凉丶',
            url: 'https://space.bilibili.com/22088751',
          },
        ],
        heroName: '卡扎克·独眼',
        order: 1,
      },
      {
        heroNickName: '鸦父',
        heroAvatarPath:
          'assets/images/lords/beastmen-malagor-the-dark-omen.png',
        path: 'assets/images/icons/Beastmen/Harbinger_of_Disaster.png',
        name: 'Harbinger_of_Disaster',
        nameCN: '灾厄先驱',
        description:
          '<p>开局攻下“赫尔纳齐洼地”，竖立万魔岩创造“血域”。</p><p>宣战顶髻，和斯卡布兰德一起瓜分他的地盘。</p><p>之后我们可以随意发展。</p><p>马拉戈·黑暗征兆的核心玩法是利用“隐蔽营地”悄然接近敌人，发起伏击。</p><p>前期以练级为主，升到12级可以点“特殊线”，最快点出“群鸦蔽日”学会“无尽群鸦盛宴”，就可以让敌人感受无尽的痛苦。</p><p>消灭附近所有的派系。</p>',
      ...
      },
      {
        heroNickName: '蘑菇儿',
        heroAvatarPath:
          'assets/images/lords/beastmen-morghur-the-shadowgave.png',
        path: 'assets/images/icons/Beastmen/Warherd_of_the_Shadowgave.png',
        name: 'Warherd_of_the_Shadowgave',
        nameCN: '影孽战兽群',
        description:
          '<p>开局攻下“蒙特纳斯”，竖立万魔岩创造“血域”。</p><p>向南进军，快速拿下整个“埃斯塔利亚”，敌人是帝国派系“南方王国”，然后可以进攻“湖神仙女”。</p><p>魔古尔·影孽的核心玩法是利用被动技能“卑鄙嬗变光环”的烧血效果消耗敌军兵模，回血光环可以恢复自身血量。</p><p>小模组、高移速，让影孽成为“移动烧血机”。</p><p>大量的角兽群结合混沌之卵可以对敌人进行毁灭打击。</p><p>攻下“卡尔卡松”，即可破局。</p>',
      ...
      },
      {
        ...
        heroAvatarPath:
          'assets/images/lords/beastmen-taurox-the-brass-bull.png',
        path: 'assets/images/icons/Beastmen/Slaughterhorn_Tribe.png',
        name: 'Slaughterhorn_Tribe',
        nameCN: '屠灭之角部落',
        description:
          '<p>开局攻下“克拉卡隆德”，竖立万魔岩创造“血域”。</p><p>一路向东，敌人都是黑暗精灵，先消灭挡住前路的塞洛斯塔·恐怖之鳍，最后和“影王”阿里斯·安纳尔进行终极对决。</p><p>陶诺斯·铜牛拥有强大的物理输出和高护甲，他能身先士卒带领牛头怪部队轻易摧毁敌人的防线，结合战獒的高速迂回战术，轻松击败敌人。</p><p>消灭阿里斯·安纳尔之后，即可破局。</p>',
    ...
    files: [
      {
        ...
        nameCN: '哥隆尼',
        description:
          '<p>第一场战争会考验玩家使用骑兵的能力，攻下“勒·安古朗”。</p><p>前期最难缠的敌人是绿皮派系“大肚王·咕噜”，先消灭吸血鬼伯爵派系“穆席隆”，进攻奥卡山。</p><p>警惕西北方的混沌勇士“比拉克”，他随时可能穿过奥比恩海峡入侵你。</p><p>劳恩·列奥康沃尔是一位伟大的巴托国王，在战场上利用好骑兵部队，他们拥有很多优异的加成效果。</p><p>搭配抗线的老农部队，善用士气打击，进行机动作战，就能取得不错的战果。</p><p>消灭大肚王·咕噜，即可破局。</p>',
        id: 'Couronne',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        heroNickName: '海产王',
        heroAvatarPath:
          'assets/images/lords/bretonnia-alberic-de-bordeleaux.png',
        path: 'assets/images/icons/Bretonnia/Bordeleaux_Errant.png',
        name: 'Bordeleaux_Errant',
        nameCN: '波尔德洛长征军',
        description:
          '<p>攻下“扎慧塔克”和“塔拉克斯兰”统一“食人鱼沼泽”。</p><p>接下来主要的敌人是吸血鬼海盗“卢瑟·哈肯”和南方的蜥蜴人“哥罗克”。</p><p>艾博里克·德·波尔德罗的技能“恢弘打击”拥有反大加成，再加上“波尔德罗冠军勇士”，使得他的“王国骑士”非常适合攻击蜥蜴人这种大型部队较多的派系。</p><p>善用骑兵，依靠机动迂回的战术，可以取得不错的效果。</p><p>消灭卢瑟·哈肯和哥罗克，即可破局。</p>',
      ...
      },
      {
        ...
        nameCN: '卡尔卡松',
        description:
          '<p>初始战的敌人是绿皮派系“红云”，依靠强大的神佑投石机和圣杯骑士，可以轻松击败他们。</p><p>接下来，快速集结部队，消灭盘踞在奥卡山的大肚王·咕噜。</p><p>警惕南方的斯卡文鼠人“伊克特·利爪”和游牧野兽人派系“魔古尔·影孽”。</p><p>湖神仙女开局就有神佑投石机和圣杯骑士，强大的巴托尼亚骑士领主，再加上大量的老农部队。</p><p>在战场上有着强悍的实力。</p><p>消灭大肚王·咕噜，即可破局。</p>',
        id: 'Carcassonne',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '里昂尼斯骑士战团',
        description:
          '<p>攻下“费拉斯”和“亥卡”统一“阿拉比海岸”。</p><p>通过外交与“欧瑞格骑士”合邦，进攻西南方的“术士群岛”，那里是古墓王“黑色·阿克汉”的地盘。</p><p>也可以东进或南下，选择很多。</p><p>赫潘丝·德·里昂尼斯是一位强大的少女骑士，拥有爆炸技能“少女之怒”，可以反复爆炸击杀敌军。</p><p>升到9级后点出“放逐天灾”能让她的部队获得高额加成，在对付吸血鬼和古墓王派系时得心应手。</p><p>强大的骑士部队在发起冲锋后能给予敌人致命一击。</p>',
  ...
  },
  {
    ...
    files: [
      ...
      },
      {
        heroNickName: '扎坦',
        heroAvatarPath:
          'assets/images/lords/chaos-dwarves-zhatan-the-black.png',
        path: 'assets/images/icons/Chaos Dwarfs/The_Warhost_of_Zharr.png',
        name: 'The_Warhost_of_Zharr',
        nameCN: '扎尔战团',
        description:
          '<p>攻下“千眼要塞”统一“岩天矮丘”。</p><p>一路向东进军，拿下“鳌门关”、“龙门关”、“蝰门关”。</p><p>掌握“三关”对我们来说至关重要。</p><br/><p>主要的敌人是混沌勇士“诅咒灵·维里奇”和震旦天朝“飙龙·妙影”。</p><br/><p>黑心·扎坦的加成在于步兵和战争机器，再加上传奇事务官“戈度兹·暗算者”的高加成。 我们的部队用大地精弓箭手和大地精卑鄙潜伏者组合，使用得当，就能发挥恐怖的作战能力。</p><br/><p>消灭“诅咒灵·维里奇”和“飙龙·妙影”，即可破局。</p>',
    ...
    files: [
      {
        ...
        nameCN: '混沌大军',
        description:
          '<p>这是一个玩法多样化，甚至随心所欲的派系。</p><p>可以自由组合混沌四神派系的部队，或者说四神部队都为你所用。</p><br/><p>攻下“衰败森林”、“蝇塔”、“呕胆崖”统一“恶臭肿瘤”。</p><p>向东进军攻打奸奇派系“全视之眼”，占领火山之心，之后会遇到主要的对手“马鲁斯·黑刃”。</p><br/><p>部队组合很自由，我推荐“恐虐”与“色孽”组合，拥有恐怖的肉搏能力，也可以选择“恐虐”与“奸奇”，如果你喜欢“射爆流”玩法。</p><p>“纳垢”与“色孽”或“奸奇”也是一种组合方案。</p><p>恶魔亲王的装备也有很多选择，可随意调整，十分强力。</p><br/><p>消灭“马鲁斯·黑刃”，即可破局。</p>',
        id: 'Legion_of_Chaos',
        contributors: [
          {
            id: 3,
    ...
    files: [
      {
        ...
        nameCN: '纳迦隆德',
        description:
          '<p>开局攻下“哈尔·卡拉卓”, 直接直奔西南，拿下“锐克杜山下”。</p><p>如果速度不够快，斯卡文鼠人的派系会控制南方的“凯恩神殿”，给我们造成不小的麻烦。</p><p>我们需要截住敌人的主力,返回终极黑暗祭坛。</p><p>这时白矮人·格瑞姆布林戴尔的主力也会到达此地，我们需要消灭他们。</p><p>穿过白矮人的领土,从“夸格兹深渊”进行战略迂回, 消灭“影王”阿里斯·安纳尔。</p><p>注意与北方“瓦尔基娅”的外交关系，避免双线作战。</p><br/><p>纳迦罗斯的巫王“马雷基斯”是一位魔武双修的领主，先加法师技能点。</p><p>“利刃狂风”和“窃魂术”都是核心技能，升到12级后点特殊线技能，可以给派系带来非常大的加成。</p><p>搭配极其强力的射爆体系，黑暗精灵的作战能力非常优秀。</p><br/><p>消灭格瑞姆布林戴和阿里斯·安纳尔之后，即可破局。</p>',
        id: 'Naggarond',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '欢愉教派',
        description:
          '<p>开局攻下“石化森林”和“希拉卓·塔尔”。</p><p>在“铁刺镇”向北迂回的同时消灭斯卡文鼠人，就可以到达“海格之厅”，消灭“奥斯坦基娅嬷嬷”，从凄凉海岸的“碎月山”渡海进攻奥苏安。</p><p>这是一个比较完美的闭环路线。</p><br/><p>莫拉斯是至高女巫，拥有极强的法术输出能力。</p><p>前期加完法师技能后，可以适当保留技能点，用来加特殊线。</p><p>“幽暗深渊”技能有着强大的输出伤害，结合黑暗精灵领主的优秀属性，可以发挥强大的作战能力。</p><br/><p>迂回后，消灭奥斯坦基娅嬷嬷，即可破局。</p>',
        id: 'Cult_of_Pleasure',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '哈尔·冈西',
        description:
          '<p>消灭绿皮派系“破笼者”，他的领土都属于你。</p><p>注意与混沌勇士“瓦尔基娅”的外交关系，不要与“戈隆德”签订任何条约。</p><p>占领“纳格尔”后渡海登录“破败之地”。</p><p>可以通过“加入战斗”的方式迷惑“影王”阿里斯·安纳尔，再伺机一举消灭他，接着直奔奥苏安。</p><br/><p>妖婆赫莉本是一位敏捷的杀手，擅长单挑并斩杀敌方领主。</p><p>快速练级，解锁坐骑“沸腾血池”。</p><p>在特殊线点出“血腥女王”，增加重生能力。</p><p>沸腾血池作为一个多模组攻击的小型判定单位，加上烧血光环，让妖婆赫莉本拥有了非常恐怖的无双能力。</p><br/><p>消灭阿里斯·安纳尔，即可破局。</p>',
        id: 'Har_Ganeth',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '神佑恶党',
        description:
          '<p>攻下“北齐”，敌人是吸血鬼海岸派系“死旗舰队”。</p><p>和“艾辛氏族”建立友好的外交关系，之后就可以进攻“镔龙·昭明”，注意与蜥蜴人“纳卡伊”的外交关系。</p><p>也可以灭掉蜥蜴人，也是一种简单实在的战略选择。</p><br/><p>开局位置很好，利于发展。</p><br/><p>核心玩法通过占领港口主城，招募“黑色方舟”。</p><p>用很低的维护费组件大量的军队，进行海岸侵袭。</p><br/><p>洛克西亚·堕落之心是一个非常“硬”的近战领主。</p><p>领主本队的“黑色方舟海盗部队”可以获得高额的加成。</p><p>获得坐骑黑龙“波涛漩涡”之后，可以给予敌人致命一击。</p><br/><p>消灭镔龙·昭明，即可破局。</p>',
      ...
      },
      {
        ...
        nameCN: '海格·葛雷夫',
        description:
          '<p>攻下“黑岩”，消灭奸奇派系“零落命轮”。</p><p>我们的主要敌人是“恶魔亲王”，一路向东，消灭他们。</p><p>之后就可以随心所欲的洗劫占领了。</p><br/><p>马鲁斯·黑刃是为数不多的，开局就能进行“无双”，深入敌阵的领主。</p><p>他拥有超强的体魄，还能变身“扎坎”，等于拥有两次生命。</p><br/><p>通过“炼金药”驱逐扎坎快速发展，或者是让扎坎完全附身，增强部队的作战能力。</p><br/><p>消灭恶魔亲王，即可破局。</p>',
        id: 'Hag_Graef',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '千噬',
        description:
          '<p>消灭“瑟提哨站”，统一“海龟群岛”。</p><p>接下来是一个选择点，北上进攻玉龙·元伯，或者南下进攻“蛇神先知”特亨霍因。</p><p>从战略上来说，进攻特亨霍因比玉龙·元伯好，因为可以得到稳定的发展地盘。</p><br/><p>拉卡斯是驯兽师，自身作战能力并不算强。</p><p>可以招募大量的强力怪兽来进行战斗，所以拉卡斯是黑精派系中最需要操作的。</p><p>大量的野兽单位能如巨浪般的淹没敌人，正面冲击就行，也可以包抄，敌人都会被轻易摧毁。</p><br/><p>消灭玉龙·元伯或特亨霍因，即可破局。</p>',
    ...
    files: [
      {
        ...
        nameCN: '卡拉扎-阿-卡拉克',
        description:
          '<p>向东攻下“葛朗尼石厅”、“史奎格独角山”，统一“白银之路”。</p><p>敌人是绿皮派系“血矛”，他们只是个小威胁。</p><p>招募副领主，攻下“至高之地”后，我们会遇上邪月“史卡斯尼克”的主力。</p><p>可以伏击，抓住机会消灭他们。</p><p>也可以直接突进上去干。</p><p>前期主力作战单位是雷管矿工。</p><br/><p>索尔格林是一位非常“硬”的矮人传奇领主。</p><p>大师级恶怨符文是他的主要输出手段。</p><p>先点红线，留点加特殊线技能。</p><br/><p>消灭史卡斯尼克，即可破局。</p>',
        id: 'Karaz_a_Karak',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        heroNickName: '白矮人',
        heroAvatarPath:
          'assets/images/lords/dwarves-grombrindal-the-white-dwarf.png',
        path: 'assets/images/icons/Dwarfs/The_Ancestral_Throng.png',
        name: 'The_Ancestral_Throng',
        nameCN: '先祖之军',
        description:
          '<p>攻下“上古尖塔”、“终极黑暗祭坛”，统一“镔铁海岸”。</p><br/><p>在终极黑暗祭坛，可能会撞上“娜迦隆德”的主力。</p><p>伏击“马雷基斯”或者与他正面开战，也可以等他们攻城，我们在后面偷袭，这里有很多选择。</p><br/><p>“白矮人”格瑞姆布林戴尔是一位强力的近战领主，开局部队的“铁龙手炮兵”杀伤力惊人。</p><p>推荐红线加点，12级前留点加特殊线技能。</p><p>矮人直升机飞机和铁龙手炮兵可以获得很好的战果。</p><p>注意黑暗精灵的弩手部队，破甲伤害对矮人是不小的威胁。</p><br/><p>消灭马雷基斯，即可破局。</p>',
      ...
      },
      {
        ...
        nameCN: '铁眉远征军',
        description:
          '<p>攻下“失落高原”、“蛛网山”，统一“南地世界边缘山脉”</p><p>一路北上，打下“卡拉格·红云山”，拿下你的第一个神器。</p><br/><p>有两个选择，宣战西面的恐虐派系“斯卡布兰德”，和他厮杀。</p><p>也可以向东，帮助至高女王消灭吸血鬼，穿过迷雾山，进攻奎克·猎头者，拿下一件神器。</p><p>去八峰山方向的神器比较多，路线也更好走。</p><br/><p>托雷克·铁眉是一位传奇符文铁匠，给部队非常高的加成，自身的属性也很好。</p><p>恶怨符文输出，矿工（雷管）和重矢弩手组合能轻松干掉周围的敌人。</p><p>主加红线技能。</p><br/><p>消灭斯卡布兰德或者奎克·猎头者，即可破局。</p>',
    ...
    files: [
      {
        ...
        nameCN: '瑞克领',
        description:
          '<p>消灭叛军“帝国分离势力”，统一“瑞克领”。</p><p>集结部队进攻西北方的“玛丽恩堡”，也是帝国派系，但和卡皇关系并不好。</p><p>拿下玛丽恩堡后可以招募边民骑手，他可以使用榴弹发射器，简称“榴弹骑”。</p><br/><p>一路北上，消灭宿敌“卡扎克·独眼”。</p><p>向“黄铜要塞”进军攻打“费斯图斯”，也是我们必须要消灭的敌人。</p><br/><p>卡尔·弗兰茨前期的身板并不“硬”，作战时需要注意他的血量。</p><p>红线加点，然后加特殊线。</p><br/><p>副领主招募“工程大师”，非常好用。</p><p>可以选择“射爆流”或是骑兵与工程大师组合的“炮轰流”，都非常舒服。</p><br/><p>消灭弗卡扎克·独眼和费斯图斯，即可破局。</p>',
        id: 'Reikland',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '黄金学院',
        description:
          '<p>5.0版本之后，拜尔沙泽·盖尔特的初始位置已经移动到了“天离烈土”，这儿是震旦天朝的势力范围。</p><br/><p>攻下“精风寺” ，先占领一个城市。</p><p>可以兵分两路，让主队拜尔沙泽·盖尔特进入西南峡谷隧道，攻打“蓝玫瑰车队”赫尔曼·苟斯特和纳垢派系“库嘎斯·瘟父”。</p><p>副队进攻“燃风牧民”。</p><br/><p>消灭两大威胁后，拿下“巨龙群岛”这块肥硕之地。</p><br/><p>得益于5.0版本对于“魔法学院”的改动，通过得到“奥数论文”，可以快速组建“法师大队”，战力惊人。</p><p>主加法师线和特殊线。</p><br/><p>消灭赫尔曼·苟斯特和库嘎斯·瘟父，即可破局。</p>',
        id: 'The_Golden_Order',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '猎人元帅远征军',
        description:
          '<p>开局消灭一支斯卡文鼠人部队，在南美（露丝契亚），猎人元帅的主要任务是消灭蜥蜴人。</p><p>进攻“塔兰克斯拉”，以大白蜥“哥罗克”为攻略目标。</p><br/><p>马库斯·沃法特在“特殊线”技能的加成下，招募“工程大师”，战力很恐怖。</p><p>通过不停的征战，获得帝国的援兵。</p><br/><p>外交上与艾博里克·德·波尔德罗和玉龙·元伯联合，在南美可以肆意妄为。</p><br/><p>消灭哥罗克，即可破局。</p>',
      ...
      },
      {
        ...
        nameCN: '西格玛教会',
        description:
          '<p>消灭“沙丘王国”，统一“苦行僧之地”。</p><p>在夺取“漂移沙地”时，会碰上曼弗雷德·冯·卡斯坦因（吸血鬼伯爵）的部队。</p><p>可以借刀杀人，也可以直接向他宣战。</p><br/><p>击败曼弗雷德主队后，一鼓作气拿下他的地盘。</p><p>接下来消灭附近所有的古墓王派系。</p><br/><p>沃克玛·无情者可以招募非常强力的牧师领主，这是他的厉害之处。</p><p>这些牧师技能CD短、自身属性优秀。</p><p>再加上工程大师，破局简单。</p><br/><p>消灭曼弗雷德·冯·卡斯坦因，即可破局。</p>',
        id: 'Cult_of_Sigmar',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '威森领与努恩',
        description:
          '<p>攻下“道腾巴赫”、“威森堡”，统一“威森领”。</p><p>拿下“索尔领”，第五回合在“穆特”建造“莫尔花园”和附属建筑“莫尔民兵营”，攻下“索尔要塞”。</p><p>传送至穆特，与吸血鬼派系希尔瓦尼亚“弗拉德·冯·卡斯坦因”开战。</p><br/><p>前期战损很低，建造“法师密会所”，准备招募“烈焰法师”，他是对付绿皮和吸血鬼的强力单位。</p><p>招募一个“大诵经师”领主作为前排。</p><p>墓园玫瑰护甲很低，不要近战。</p><p>大工程师的默认武器榴弹是很强的反步兵手段。</p><p>火枪手、努恩铁甲军、黑色玫瑰团骑士、地狱风暴火箭炮都是核心战力。</p><br/><p>消灭弗拉德·冯·卡斯坦因，即可破局。</p>',
        id: 'Wissenland_Nuln',
        contributors: [
          {
            id: 6,
            name: '时间老猫',
            url: 'https://space.bilibili.com/12426474',
          },
        ],
        heroName: '埃斯佩斯·冯·邓肯',
        order: 5,
    ...
    files: [
      {
        ...
        nameCN: '卫北列省',
        description:
          '<p>攻下“南离”，统一“硝硫路”，接着拿下“蕹昌”、“兵马俑墓园”、“魄魅”，统一“岩镔原”。</p><p>快速集结部队，直扑东南方的绿皮派系“点心”。</p><p>攻下点心的主城后，会与艾辛氏族相遇，消灭他们。</p><p>下一个目标是洛克西亚·堕落之心。</p><br/><p>飙龙·妙影是拥有强大法术的法师，“大地之血”为部队补充血量。</p><p>震旦部队属性优异，注意保持“武道宁和”。</p><p>外交上与“帝国戍卫”和“天庭忠卫”合邦。</p><br/><p>控制长垣，抵御库尔甘战帮和维里奇的进攻。</p><br/><p>扫平震旦境内威胁，消灭艾辛氏族和洛克西亚·堕落之心，即可破局。</p>',
      ...
      },
      {
        ...
        nameCN: '卫西列省',
        description:
          '<p>攻下“瀚宇港”，统一“缙绅荒原”。</p><p>灭掉“新武”的斯卡文鼠人，北攻“上阳”，到达“泰梓”后，可以向东北进攻，背刺“艾辛氏族”，拿下行省“皓月林”。</p><p>合邦“玉石护军”，消灭吸血鬼伯爵派系“僵尸叛军”，宣战洛克西亚·堕落之心。</p><br/><p>他的出生点很好，破局简单。</p><br/><p>镔龙·昭明兼通“金属系”和“阳系”的双修法师，还有强大的近战肉搏能力。</p><p>对近战部队有很好的加成。</p><br/><p>消灭艾辛氏族，即可破局。</p>',
      ...
      },
      {
        ...
        nameCN: '玉廷',
        description:
          '<p>玉龙·元伯开局就是双线发展。</p><br/><p>在南美（露丝契亚）消灭蛮荒兽人派系“蓝蝰蛇”，沿着海岸，向正南方往“千噬”方向进攻。</p><p>震旦方向招募部队攻打吸血鬼伯爵派系“僵尸叛军”，统一“天廷河源”，之后进攻“艾辛氏族”和洛克西亚·堕落之心。</p><br/><p>玉龙·元伯属性优异，拥有无与伦比的近战肉搏能力，强大的“无双”，可以斩杀敌方领主或部队。</p><p>拥有天堂系法术“卡莎朵拉彗星”和阴系法术“夜鸮决”可以大范围秒杀敌方部队。</p><br/><p>“国是”机制可以加速完成招募和建造。</p><br/><p>消灭千噬，即可破局。</p>',
        id: 'The_Jade_Court',
        contributors: [
          {
            id: 3,
    ...
    files: [
      {
        ...
        nameCN: '格里姆格的狠小子',
        description:
          '<p>消灭食人魔派系“佛戈”，统一迦什·卡德拉克。</p><br/><p>接下来有两个选择，向南攻略大金牙，或者向北拿下“东行之路”，与“扎尔之奴”合邦，干掉混沌矮人派系“哈苏特信徒”，也就是阿斯特戈斯·铁手。</p><br/><p>格里姆格·铁皮是最强近战领主之一，技能“硬得要死”、“强中之强”，再加上“维生素蘑菇”，让他变得无比强硬。</p><p>强力的黑兽人部队，“废料”机制可以升级部队作战力。</p><p>战场上，在合适的时机开启Waaagh，可以让我们一路碾压过去。</p><br/><p>此外，绿皮的“劫掠营地”状态不消耗移动点数，非常实用。</p><br/><p>消灭格雷苏·大金牙 或者 阿斯特戈斯·铁手，即可破局。</p>',
        id: 'Grimgors_Ardboyz',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        heroNickName: '阿兹汗',
        heroAvatarPath:
          'assets/images/lords/greenskins-azhag-the-slaughterer.png',
        path: 'assets/images/icons/Greenskins/Bonerattlaz.png',
        name: 'Bonerattlaz',
        nameCN: '响骨',
        description:
          '<p>消灭食人魔派系“硬石脑袋”，统一“北世界边缘山脉”。</p><br/><p>南边就是“屠夫王”——阿格里姆·铁拳，在他还没有完全消灭“赤目”时，突袭“卡拉克·卡德林”。</p><p>只要拿下这座城，他就不再具备招募“屠夫”的能力，之后就好对付了。</p><br/><p>阿兹汗·屠灭者是死亡系的兽人法师，开局还有一个“大Waaagh!”系法师。</p><p>特殊线技能对兽人小子和大只佬有很高加成，这样阿兹汗主队拥有很强的战斗力。</p><p>开启Waaagh横扫矮人不在话下。</p><br/><p>消灭“屠夫王”阿格里姆·铁拳，即可破局。</p>',
        id: 'Bonerattlaz',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '邪月',
        description:
          '<p>消灭绿皮派系“血矛”，统一“死岩裂口”。</p><br/><p>在拿下“至高之地”时，在可以在山口埋伏“至高王”索尔葛林·负怨者的部队，伏击成功就可以轻松干掉他们。</p><p>攻下“卡拉扎-阿-卡拉克”，统一“白银之路”。</p><p>继续向南闪电推进，抢在奎克·猎头者之前夺取八峰山。</p><br/><p>邪月派系前期最依仗的就是体质不错的地精首领 加上夜地精的疯狂转子. 配合巨蛛的惊骇恐惧可以让敌人快速灰飞烟灭. 整体战术选择领主上前抗住战线之后用转转快速清兵即可.</p><br/><p>前期拿下八峰山 即可宣告破局.</p>',
        id: 'Crooked_Moon',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        heroAvatarPath:
          'assets/images/lords/greenskins-wurrzag-da-great-green-prophet.png',
        path: 'assets/images/icons/Greenskins/The_Bloody_Handz.png',
        name: 'The_Bloody_Handz',
        nameCN: '血手',
        description:
          '<p>开局打下“龙角矿场”，就可以与“劫牙”合邦。</p><p>先统一“西恶地”。</p><p>“东恶地”、“南恶地”，要逐一攻略，都是短期战役胜利的目标。</p><br/><p>乌尔扎戈·绿先知是一位强大的“大Waaagh!”系法师，“爆脑术”在前期是一个很强的输出技能，中期技能“搞哥大脚”也非常强力。</p><p>蛮荒兽人拥有极强的进攻能力，拥有“战纹”能抵御物理攻击，但惧怕魔法。</p><p>在战场上，当敌方有大范围aoe魔法时，要注意部队的拉扯。</p><br/><p>一统恶地，即可破局。</p>',
        id: 'The_Bloody_Handz',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '碎斧',
        description:
          '<p>攻下“阿奎坦”，直接跨海袭击艾萨里昂·无情者（外号：牢头），牢头这时刚好在和下方的绿皮干仗，背刺牢头，就可以和岛上的绿皮派系合邦。</p><br/><p>大肚王·咕噜的地精部队拥有极高的上限, 价格便宜，作战能力强，招募迅速。</p><p>在前期可以变成“地精海”，搭配独有的“泵车”部队，让敌人闻风丧胆。</p><br/><p>大肚王·咕噜本人是一个战车单位，战场上要多多移动，打乱敌人的阵型。</p><br/><p>消灭艾萨里昂·无情者，即可破局。</p>',
        id: 'Broken_Axe',
        contributors: [
          {
            id: 3,
    ...
    files: [
      {
        ...
        nameCN: '伊泰恩',
        description:
          '<p>消灭“纵姿教派”。在诺克特拉斯伯爵没有在奥苏安立稳脚跟时,把他打掉，要完全消灭，将葬船坟场连根拔除。</p><p>之后就直接攻入北美，消灭莫拉斯即可。</p><br/><p>高精的优势在于硬实的长矛兵和射程优秀的射手部队，在前期这对组合是利器，加成很高，可以用到中后期。</p><br/><p>泰瑞昂是属性最优秀的创奇领主之一。</p><br/><p>消灭莫拉斯，即可破局。</p>',
        id: 'Eataine',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '魔剑士议会',
        description:
          '<p>开局打掉萨“索瑞尔·永世守望”，接下来向北消灭大众脸鼠人派系和蜥蜴人，获得一个稳定的发展环境之后，再南下对付卡洛斯·织命者。</p><p>时机合适，卡洛斯和变色龙会打起来。</p><p>当然卡洛斯也可能先对我方宣战。</p><br/><p>泰格里斯是非常强力的法师领主。</p><p>副领主可以再培养一些法师，比如生命法或者阴影法。</p><p>泰格里斯的法师初始等级就很高，成型非常快。</p><br/><p>消灭卡洛斯·织命者，即可破局。</p>',
      ...
      },
      {
        heroNickName: '永恒女王',
        heroAvatarPath:
          'assets/images/lords/high-elves-alarielle-the-radiant.png',
        path: 'assets/images/icons/High Elves/Avelorn.png',
        name: 'Avelorn',
        nameCN: '阿瓦隆',
        description:
          '<p>消灭掉凯恩之鞭。</p><p>可以不洗劫凯恩圣殿，等纳卡里与柯思奎鏖战之际，直接从背后偷袭他。</p><p>高等精灵打色孽还是比较好打，色孽AI的配兵也比较随意。</p><p>打败纳卡里后，可以直接穿透北美，朝妖婆赫莉本和马雷基斯的方向进攻即可。</p><br/><p>艾拉瑞丽是一位非常强力的法师，可以招募树妖和树精。</p><p>组成优秀的“射爆流”部队，还可以采取近战肉搏搭配骑兵的战法，都是不错的选择。</p><br/><p>消灭纳卡里，即可破局。</p>',
        id: 'Avelorn',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '纳迦瑞斯',
        description:
          '<p>消灭卡隆德·卡尔，拿下“花岗岩丘陵”、“破败之地”。</p><p>向西灭掉塞洛斯塔·恐怖之鳍和陶诺斯·铜牛，向北进行战略迂回，进攻纳迦隆德。</p><br/><p>影王阿里斯·安纳尔最出色的部队是“影行者战团”。 影行者战团可以潜行、机动性高，还拥有非常远的射程。</p><p>灵活操控，能进行强力一击，快速把敌人打崩。</p><br/><p>消灭娜迦隆德，即可破局。</p>',
        id: 'Nagarythe',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '伊瑞斯',
        description:
          '<p>艾萨里昂·无情者开局就是双线作战，也可以放弃一边，单线发展。</p><p>恶地方向我们需要先消灭顶髻，接下来的首要目标是血手，斯卡布兰德先缓一缓。</p><p>奥苏安线可以先消灭绿皮派系颅岩，修建防御设施，预防大肚王·咕噜登岛袭击。</p><br/><p>艾萨里昂·无情者魔武双修，非常强力，麾下的“迷雾行者”部队是一大杀器。</p><p>技能对部队又很高的加成。</p><br/><p>消灭娜迦隆德，即可破局。</p>',
        id: 'Yvresse',
        contributors: [
          {
            id: 3,
      ...
      },
      {
        ...
        nameCN: '卡勒多骑士',
        description:
          '<p>消灭矮人派系“赫尔海因”氏族，统一骸骨平原。</p><p>接下来去东北放的黑堡，拦截阿佐格军团的主力部队。</p><p>击败主力就顺势消灭他，下一个目标是崔特思·畏尾。</p><br/><p>总体没有太大难度，如果合邦老家，宜静观其边，不可贸然出击。</p><br/><p>龙王子的“领主流”非常强，前期不需要太多部队。</p><p>骑龙之后，配合贵族与法师，就可以大杀四方。</p><br/><p>消灭阿佐格军团和崔特思·畏尾，即可破局。</p>',
  ...
  },
  {
    ...
    files: [
      ...
      },
      {
        heroNickName: '可汗',
        heroAvatarPath:
          'assets/images/lords/nurgle-tankhan-the-maggot-lord.png',
        path: 'assets/images/icons/Nurgle/Poxmakers_of_Nurgle.png',
        name: 'The_Maggot_Host',
        nameCN: '蛆虫军团',
        description:
          '<p>开局往南方进攻，死敌柯烈克·食日者等着你，你和他只有一个能活在这个世界。</p><p>攻下"绞架树"一统"卡达莎"，接着进攻"奇美拉高地"。</p><p>存够"霸权"(纳垢资源)立刻招募"玷污者·凯兹克"，自带坐骑，移速达到80+，武器威力560，还能重生。</p><p>手动战中利用凯兹克和强大的腐烂骑士(也会重生)，将敌军作战单位一个接一个勾引出来围杀是上好的战术。</p><p>击败柯烈克·食日者即可完成前期破局。</p>',
        id: 'The_Maggot_Host',
        contributors: [
          {
            id: 1,
            name: '古老游戏玩家',
            url: 'https://space.bilibili.com/431259608',
          },
        ],
        heroName: '蛆虫之主·塔木尔可汗',
        order: 2,
    ...
    files: [
      {
        heroNickName: '大金牙',
        heroAvatarPath:
          'assets/images/lords/ogre-kingdoms-greasus-goldtooth.png',
      ...
      },
      {
        heroNickName: '厨子',
        heroAvatarPath:
          'assets/images/lords/ogre-kingdoms-skrag-the-slaughterer.png',
    ...
    files: [
      {
        ...
        heroAvatarPath:
          'assets/images/lords/tomb-kings-settra-the-imperishable.png',
      ...
      },
      {
        heroNickName: '大祭司',
        heroAvatarPath:
          'assets/images/lords/tomb-kings-grand-hierophant-khatep.png',
  ...
  },
  {
    ...
    files: [
      ...
      },
      {
        heroNickName: '盐怨、猴王',
        heroAvatarPath:
          'assets/images/lords/vampire-coast-aranessa-saltspite.png',
      ...
      },
      {
        heroNickName: '歌女、肥婆',
        heroAvatarPath:
          'assets/images/lords/vampire-coast-cylostra-direfin.png',
    ...
    files: [
      {
        heroNickName: '曼光头',
        heroAvatarPath:
          'assets/images/lords/vampire-counts-mannfred-von-carstein.png',
      ...
      },
      {
        ...
        heroAvatarPath:
          'assets/images/lords/vampire-counts-heinrich-kemmler.png',
      ...
      },
      {
        ...
        heroAvatarPath:
          'assets/images/lords/vampire-counts-vlad-von-carstein.png',
      ...
      },
      {
        heroNickName: '伊莎贝拉',
        heroAvatarPath:
          'assets/images/lords/vampire-counts-isabella-von-carstein.png',
        path: 'assets/images/icons/Vampire Counts/Sylvania.png',
        name: 'Sylvania',
        nameCN: '希尔瓦尼亚',
        description: null,
    ...
    files: [
      {
        heroNickName: '阿查',
        heroAvatarPath:
          'assets/images/lords/warriors-of-chaos-archaon-the-everchosen.png',
      ...
      },
      {
        ...
        heroAvatarPath:
          'assets/images/lords/warriors-of-chaos-kholek-suneater.png',
      ...
      },
      {
        heroNickName: '美人',
        heroAvatarPath:
          'assets/images/lords/warriors-of-chaos-prince-sigvald-the-magnificent.png',
      ...
      },
      {
        heroNickName: '医生',
        heroAvatarPath:
          'assets/images/lords/warriors-of-chaos-festus-the-leechlord.png',
      ...
      },
      {
        heroNickName: '瓦鸡',
        heroAvatarPath:
          'assets/images/lords/warriors-of-chaos-valkia-the-bloody.png',
      ...
      },
      {
        heroNickName: '维里奇',
        heroAvatarPath:
          'assets/images/lords/warriors-of-chaos-vilitch-the-curseling.png',
  ...
  },
  {
    ...
    files: [
      ...
      },
      {
        ...
        heroAvatarPath:
          'assets/images/lords/wood-elves-sisters-of-twilight.png',
