...
DOWNLOAD_URL = 'https://vip7.ljbfbf.com/20240810/2jxCwxwz/'
...
def download_m3u8(m3u8_url):
    ...
    for line in response.text.splitlines():
        line = line.strip()
        if line.endswith('.ts') and line.startswith(DOWNLOAD_URL):
    ...
    for ts_url in ts_files:
        if ts_url.startswith(DOWNLOAD_URL):
...
if __name__ == "__main__":
    m3u8_url = DOWNLOAD_URL + "hls/index.m3u8"  # 替换为你的 M3U8 链接
