...
@Component({
  standalone: true,
  imports: [NxWelcomeComponent, RouterModule, BannerComponent, ClassifierComponent, ItemCardComponent, NgForOf, NgIf, SlideshowComponent, WarhammerClassifierComponent, WarhammerClassifierComponent],
  selector: 'st-root',
