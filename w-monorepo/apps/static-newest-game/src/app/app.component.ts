...
export class AppComponent {
  ...
  public strategy: IItemCard[] = ARTICLES_MAP['17'];
  public liveRecording: IItemCard[] = ARTICLES_MAP['discount'];
  public backgroundKnowledge: IItemCard[] = ARTICLES_MAP['discount'];
