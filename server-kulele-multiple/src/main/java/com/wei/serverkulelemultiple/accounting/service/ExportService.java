...
public class ExportService {
    ...
    private byte[] generatePdf(List<AccountingRecordDTO> records, String title) {
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            int rowIndex = 0;
            if (records.isEmpty()) {
                com.itextpdf.layout.element.Cell noDataCell = new com.itextpdf.layout.element.Cell(1, headers.length)
                ...
                for (AccountingRecordDTO record : records) {
                    ...
                    table.addCell(new com.itextpdf.layout.element.Cell().add(new Paragraph(safeStr(record.getId())))
                    ...
                    table.addCell(new com.itextpdf.layout.element.Cell().add(new Paragraph(gameNames))
                            .setBackgroundColor(bgColor)
                            .setTextAlignment(TextAlignment.LEFT));

                    table.addCell(new com.itextpdf.layout.element.Cell().add(new Paragraph(safeStr(record.getDuration())))
                            .setBackgroundColor(bgColor)
                    ...
                    table.addCell(new com.itextpdf.layout.element.Cell().add(new Paragraph(safeStr(record.getCustomerType())))
                            .setBackgroundColor(bgColor)
                            .setTextAlignment(TextAlignment.CENTER));

                    table.addCell(new com.itextpdf.layout.element.Cell().add(new Paragraph(safeStr(record.getPlatform())))
                            .setBackgroundColor(bgColor)
                            .setTextAlignment(TextAlignment.CENTER));

                    table.addCell(new com.itextpdf.layout.element.Cell().add(new Paragraph(safeStr(record.getRemark())))
                            .setBackgroundColor(bgColor)
                            .setTextAlignment(TextAlignment.LEFT)
                ...
                // 汇总行
                com.itextpdf.layout.element.Cell summaryCell = new com.itextpdf.layout.element.Cell(1, 4)
                ...
                com.itextpdf.layout.element.Cell totalDurationCell = new com.itextpdf.layout.element.Cell()
                ...
                com.itextpdf.layout.element.Cell totalAmountCell = new com.itextpdf.layout.element.Cell()
                ...
                // 剩余空单元格
                table.addCell(new com.itextpdf.layout.element.Cell().setBackgroundColor(new DeviceGray(0.9f)));
                table.addCell(new com.itextpdf.layout.element.Cell().setBackgroundColor(new DeviceGray(0.9f)));
                table.addCell(new com.itextpdf.layout.element.Cell().setBackgroundColor(new DeviceGray(0.9f)));
            }
